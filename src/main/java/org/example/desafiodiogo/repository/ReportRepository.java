...
public interface ReportRepository extends JpaRepository<ProfessorMateriaSerie, Long> {
    ...
    @Query(value = "SELECT m.nome, " +
            ...
            " m.id AS materia_id, pms.serie_id AS serie_id " +
    ...
    @Query(value = "SELECT m.nome, " +
            ...
            "FROM professores_materias_series pms " +
            "JOIN materias m ON m.id = pms.materia_id " +
            "WHERE pms.user_id = :professorId AND m.id = :disciplinaId", nativeQuery = true)
    List<Object[]> getDashboardPorDisciplina(@Param("professorId") Long professorId, @Param("disciplinaId") Long disciplinaId);
    ...
    @Query(value = "SELECT m.nome, " +
            ...
            "FROM professores_materias_series pms " +
            "JOIN materias m ON m.id = pms.materia_id " +
            "WHERE pms.user_id = :professorId AND pms.serie_id = :turmaId", nativeQuery = true)
    List<Object[]> getDashboardPorTurma(@Param("professorId") Long professorId, @Param("turmaId") Long turmaId);
    ...
    @Query(value = "SELECT m.nome, " +
            ...
            "FROM professores_materias_series pms " +
            "JOIN materias m ON m.id = pms.materia_id " +
            "WHERE pms.user_id = :professorId AND m.id = :disciplinaId AND pms.serie_id = :turmaId", nativeQuery = true)
    List<Object[]> getDashboardPorDisciplinaETurma(@Param("professorId") Long professorId, @Param("disciplinaId") Long disciplinaId, @Param("turmaId") Long turmaId);
